...
hyperparameters = {
	...
	'h_LR': 0.0014196699981655287,  # v 6e-4
	...
	'z_RHO': 'trial.suggest_float("z_rho", 0.01, 2, log=True)',
	  # best RHo 0.1574512112010004   v 0.02
	'z_MU': 'trial.suggest_float("z_mu", 0.001, 0.3, log=True)',  # Consider 0
	  # best MU 0012080696519797625  v 0.22
