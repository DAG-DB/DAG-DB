...
COMMENT = "NoNoise means effectively temperature=1, despite the " \
		  "NOISE_TEMPERATURE setting of 1. And MAX_SIZE=None"
...
hyperparameters = {
	...
	'h_NULL': None,  # 0.00581130989059376,
	...
	'NOISE_TEMPERATURE': 1,  # 0.16213500214616,
