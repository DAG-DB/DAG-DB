...
hyperparameters = {
	...
	'AFAS_SCHEDULER': None,
	# 'AFAS_SCHEDULER': 'RegularSolverScheduler(solver, h.N_EPOCHS, '
	# 				  'period=10)', ###########################
	...
	'p_LAYER': 'Bernoulli',  #################################
	'BERNOULLI_LOGIT': math.log(2 / 27),
	'STREAMLINE': False,
	'THRESHOLD': - math.log(2 / 27),  #################################

	'h_LINEAR_LAYERS': tuple(),
	'h_NULL': 1 * (- math.log(2 / 27)),  # 0.00581130989059376,

	'h_LR': 1e-2,  # 0.000655054828435191,   #######
