...
COMMENT = "For Optuna of max dag test on maxsize=None, with benefit of grid " \
		  "search re lambBA and h_NULL"
...
hyperparameters = {
	...
	'N_EPOCHS': 1_000,
	'BATCH_SIZE': None,
	'LOG2_BATCH_SIZE': 'trial.suggest_int("log2_b_size", 3, 7)',
	'BATCH_SHUFFLE': True,
	'N_SAMPLES': 'trial.suggest_int("n_sample", 5, 100, log=True)',
	...
	'h_NULL': 'trial.suggest_float("h_null", 1e-4, 0.03, log=True)',
	...
	'LAMBDA': 'trial.suggest_float("lambda", 0.3, 30, log=True)',
	...
	'BETA': None,
	'REGULARIZER': None,
	'z_RHO': 0,  # 'trial.suggest_float("z_rho", 0.01, 2, log=True)',
	'z_MU': 0,  # 'trial.suggest_float("z_mu", 0.01, 2, log=True)',
