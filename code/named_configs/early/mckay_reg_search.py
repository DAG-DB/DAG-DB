...
COMMENT = "Search with McKayZRegularizer"
...
hyperparameters = {
	...
	'MODE': 'lt_p_vector_argsort_in_std_autograd',
	...
	'NOISE_DISTRIBUTION': 'SumOfGammaNoiseDistribution(k=72)',
	...
	'z_REGULARIZER': 'McKayZRegularizer(h.D, h.z_RHO, h.z_MU, c.DEVICE)',
	'LR_SCHEDULER': None,
