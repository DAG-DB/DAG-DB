...
hyperparameters = {
	...
	'MAX_SIZE': 'trial.suggest_int("max_size", 54, 84, 6)',
	...
	'BATCH_SHUFFLE': True,
	'N_SAMPLES': 'trial.suggest_int("n_samples", 10, 50, 20)',
	...
	'h_LR': 'trial.suggest_float("h_lr", 1e-4, 0.1, log=True)',
	'h_OPTIMIZER': f'torch.optim.Adam(overall_net.h_net.parameters(), lr=h.h_LR)',
	'f_LR': 'trial.suggest_float("f_lr", 1e-4, 0.1, log=True)',
